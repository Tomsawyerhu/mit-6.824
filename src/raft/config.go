...
// applier reads message from apply ch and checks that they match the Entry
// contents
...
// how many servers think a Entry entry is committed?
...
// Maximum Entry size across all servers
